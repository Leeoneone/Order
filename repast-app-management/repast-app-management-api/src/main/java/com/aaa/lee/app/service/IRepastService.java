...
public interface IRepastService {
    ...
    List<OrderCart> ordercart(@RequestParam("id") Long id);

    /*把购车商品添加到数据库*/
    @PostMapping("/order/addcartoperation")
    Boolean addcart(@RequestBody Map<String, Object> cartdata);
    /*清空购物车*/
    @GetMapping("/order/clearcart")
    public  Boolean clearcart(@RequestParam("shopId") Long shopId);
}
